...
grace_us = 500; // Grace in microseconds. Gets deducted from the suspend time, so the game has time to prepare for the upcoming step (same as tightness, but static)
